...
## First convolutional layer: 32 features (patches), each is 5x5
...
## Second convolutional layer: 64 features, each is a 5x5 patch
...
## Final (fully) connected layer: 1024 neurons
